...
<template>
    ...
    <UButton icon="i-heroicons-calendar-days-20-solid" color="black" :label="format(date, 'd MMM, yyy')" />

    <template #panel="{ close }">
      <DatePicker v-model="date" is-required @close="close" />
    </template>
  </UPopover>
        <UInput type="file" class="mt-4 hover:bg-gray-100" size="md" icon="i-heroicons-arrow-up-tray" label="BWA hochladen" />
