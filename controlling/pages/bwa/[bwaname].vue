...
const tableData = rows.map((itemarry) =>
  itemarry.reduce((acc, curretobject) => ({ ...acc, ...curretobject }), {})
);
</script>
...
<template>
  <div class="text-center">
    ...
    <p v-else class="pb-4 text-red-600">
      {{ error }}:<br />
      This BWA does not exist! Make sure you are using the right link.
    </p>
  </div>
</template>
